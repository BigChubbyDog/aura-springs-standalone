...
const PricingPage = () => {
  ...
  // ADJUSTED Premium pricing structure - Updated pricing model (Base: $150 for 3BR/2BA up to 1300sqft)
  const pricingTiers = {
    essential: {
      ...
      pricing: {
        onetime: { '1000': 150, '1500': 175, '2000': 200, '2500': 225, '3000': 250, '3500': 275 },
        monthly: { '1000': 135, '1500': 158, '2000': 180, '2500': 203, '3000': 225, '3500': 248 },
        biweekly: { '1000': 128, '1500': 149, '2000': 170, '2500': 191, '3000': 213, '3500': 234 },
        weekly: { '1000': 120, '1500': 140, '2000': 160, '2500': 180, '3000': 200, '3500': 220 }
      }
    },
    signature: {
      ...
      pricing: {
        onetime: { '1000': 225, '1500': 263, '2000': 300, '2500': 338, '3000': 375, '3500': 413 },
        monthly: { '1000': 203, '1500': 237, '2000': 270, '2500': 304, '3000': 338, '3500': 371 },
        biweekly: { '1000': 191, '1500': 223, '2000': 255, '2500': 287, '3000': 319, '3500': 351 },
        weekly: { '1000': 180, '1500': 210, '2000': 240, '2500': 270, '3000': 300, '3500': 330 }
      }
    },
    executive: {
      ...
      excluded: [],
      pricing: {
        onetime: { '1000': 375, '1500': 438, '2000': 500, '2500': 563, '3000': 625, '3500': 688 },
        monthly: { '1000': 338, '1500': 394, '2000': 450, '2500': 506, '3000': 563, '3500': 619 },
        biweekly: { '1000': 319, '1500': 372, '2000': 425, '2500': 478, '3000': 531, '3500': 585 },
        weekly: { '1000': 300, '1500': 350, '2000': 400, '2500': 450, '3000': 500, '3500': 550 }
      }
    }
  };
